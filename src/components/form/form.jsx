...
import { FormControl, Typography, Button, Box, RadioGroup, FormLabel, FormControlLabel, Radio } from "@mui/material";
import { inputsGroupBase, inputsGroupPlatform, inputsGroupPoint } from "./templates";
        ...
        >
            ...
            <FormControl marginBottom="30px">
                ...
                <RadioGroup row defaultValue="static">
                    <FormControlLabel value="mob" control={<Radio />} label="Мобильное" onChange={clickRadioHandler} />
                    <FormControlLabel
                        value="static"
                        control={<Radio />}
                        label="Стационарное"
            ...
            {inputsGroupBase.map(el => (
                <FormItem label={el.label} text={el.text} inputFields={inputFields} setInputFields={setInputFields} />
            ))}
